...
# Font paths
try:
    fonts = pygame.font.Font(os.path.join(current_dir, "fonts/Aroman.ttf"), 35)
    action_man_fonts = pygame.font.Font(os.path.join(current_dir, "fonts/Action_Man.ttf"), 35)
    action_man_fonts_bold = pygame.font.Font(os.path.join(current_dir, "fonts/Action_Man_Bold.ttf"), 35)
except:
...
def draw_screen():
    ...
    screen.blit(action_man_fonts_bold.render(f'MAX_Scorer: {name}', True, 'black'), (10, 75))
